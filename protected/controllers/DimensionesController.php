...
class DimensionesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Dimensiones'];
			if($model->save())
	...
	{
		$model=Dimensiones::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Dimensiones $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='dimensiones-form')
		{
