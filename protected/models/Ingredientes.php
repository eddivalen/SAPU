 ...
 *
 * The followings are the available columns in table 'ingredientes':
 * @property integer $codigo
 * @property string $descripcion
 * @property double $cantidad
 * @property string $tipo
 * @property integer $und_codigo
 *
 * The followings are the available model relations:
 * @property Adicionales $adicionales
 * @property UnidadMedida $undCodigo
 * @property ProductosIngredientes $productosIngredientes
 */
class Ingredientes extends CActiveRecord
{
	/**
 ...
 // Devuelve el ítem al que le corresponde el id
	...
	public function rules()
	{
		...
		return array(
			array('descripcion, cantidad, tipo, und_codigo', 'required'),
			array('codigo, und_codigo', 'numerical', 'integerOnly'=>true),
			array('cantidad', 'numerical'),
			array('descripcion, tipo', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('codigo, descripcion, cantidad, tipo, und_codigo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'adicionales' => array(self::HAS_ONE, 'Adicionales', 'ige_codigo'),
			'undCodigo' => array(self::BELONGS_TO, 'UnidadMedida', 'und_codigo'),
			'productosIngredientes' => array(self::HAS_ONE, 'ProductosIngredientes', 'ige_codigo'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('und_codigo',$this->und_codigo);
	 ...
	 * @return Ingredientes the static model class
	 */
