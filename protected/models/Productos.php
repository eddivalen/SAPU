 ...
 * @property DimensionProductos $dimensionProductos
 ...
 // Obtiene los registros
   ...
   // self::$_items[$tipo][""]=""; // Descomentar para incluir un campo en blanco al inicio, para cuando el campo puede ser nulo
	...
	public function relations()
	{
		...
		return array(
			'dimensionProductos' => array(self::HAS_ONE, 'DimensionProductos', 'pro_codigo'),
			'productosIngredientes' => array(self::HAS_MANY, 'ProductosIngredientes', 'pro_codigo'),
		);
	}
